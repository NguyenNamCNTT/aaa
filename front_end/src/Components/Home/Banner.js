    ...
    >
      {movies.slice(0, 6).map((movie, index) => (
        <SwiperSlide key={index} className="relative rounded overflow-hidden">
          ...
          />
          <div className="absolute linear-bg xl:pl-52 sm:pl-32 pl-8 top-0 bottom-0 right-0 left-0 flex-col justify-center lg:gap-8 md:gap-5 gap-4">
            <h1
              className="xl:text-4xl truncate capitalize font-sans sm:text-2xl font-bold"
              style={{ marginBottom: "10px", marginTop: "120px" }}
            >
              {movie.name}
            </h1>
            <div
              className="flex gap-10 items-center text-dryGray"
