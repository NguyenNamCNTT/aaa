...
function Movie({ movie }) {
  ...
  return (
    <div className="border border-border p-1 hover:scale-95 transition relative rounded overflow-hidden">
      ...
      <div className="absolute flex-btn gap-2 bottom-0 right-0 left-0 bg-main bg-opacity-60 text-white px-2 py-3">
        <h3 className="font-semibold truncate w-34">{movie.name}</h3>
        <button
